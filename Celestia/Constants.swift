...
enum AppConstants {
    ...
    enum API {
        static let baseURL = "https://api.fitbuddy.app"
    ...
    // MARK: - Colors (Fitness-focused color scheme)
    enum Colors {
    ...
    // MARK: - Notifications
    enum Notifications {
        static let newMatchTitle = "New Workout Partner! 💪"
        static let newMessageTitle = "New Message"
        static let newInterestTitle = "Someone wants to train with you! 🏋️"
    }
    ...
    enum AnalyticsEvents {
        ...
        static let partnershipCreated = "partnership_created"
        static let messageSent = "message_sent"
        static let partnerRequestSent = "partner_request_sent"
        static let interestedInPartner = "interested_in_partner"
        static let passedOnPartner = "passed_on_partner"
    ...
    // MARK: - URLs
    enum URLs {
        static let privacyPolicy = "https://fitbuddy.app/privacy"
        static let termsOfService = "https://fitbuddy.app/terms"
        static let support = "mailto:support@fitbuddy.app"
        static let website = "https://fitbuddy.app"
        static let instagramURL = "https://instagram.com/fitbuddyapp"
        static let twitterURL = "https://twitter.com/fitbuddyapp"
    }
