...
class NetworkManager: NSObject {
    ...
    //    openssl s_client -connect api.fitbuddy.app:443 | openssl x509 -pubkey -noout | openssl pkey -pubin -outform der | openssl dgst -sha256 -binary | openssl enc -base64
    //
