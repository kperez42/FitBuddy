...
struct SearchFilter: Codable, Equatable {
    ...
    var workoutFrequency: ExerciseFrequency = .any
    var preferredWorkoutTime: [PreferredWorkoutTime] = []
    var gymLocation: String? = nil
    ...
    var activeFilterCount: Int {
        ...
        if !fitnessGoals.isEmpty { count += 1 }
        if !fitnessLevels.isEmpty { count += 1 }
        if !workoutTypes.isEmpty { count += 1 }
        if workoutFrequency != .any { count += 1 }
        if !preferredWorkoutTime.isEmpty { count += 1 }
        if gymLocation != nil { count += 1 }
...
enum FitnessGoal: String, Codable, CaseIterable {
    ...
    case marathonTraining = "marathon_training"
    ...
    var displayName: String {
        ...
        case .marathonTraining: return "Marathon Training"
        case .strengthTraining: return "Strength Training"
        case .toning: return "Toning & Definition"
        case .stressRelief: return "Stress Relief"
        case .socialWorkouts: return "Social Workouts"
        }
    }
    ...
    var icon: String {
        ...
        case .marathonTraining: return "figure.run.circle"
        case .strengthTraining: return "dumbbell"
        case .toning: return "figure.core.training"
        case .stressRelief: return "brain.head.profile"
        case .socialWorkouts: return "person.2"
        }
    }
}
...
enum FitnessLevel: String, Codable, CaseIterable {
    ...
    var description: String {
        ...
        case .intermediate: return "Regular workouts, familiar with exercises"
        case .advanced: return "Experienced, trains consistently"
        case .elite: return "Competitive athlete or professional"
        }
    }
}
...
enum WorkoutType: String, Codable, CaseIterable {
    ...
    var displayName: String {
        ...
        case .dance: return "Dance Fitness"
        case .teamSports: return "Team Sports"
        case .calisthenics: return "Calisthenics"
        case .hiit: return "HIIT"
        case .walking: return "Walking/Power Walking"
        }
    }
...
// MARK: - Preferred Workout Time

enum PreferredWorkoutTime: String, Codable, CaseIterable {
    ...
    var displayName: String {
        ...
        case .lateNight: return "Late Night (9 PM+)"
    ...
    var icon: String {
        ...
        case .lateNight: return "moon"
        case .weekendsOnly: return "calendar"
