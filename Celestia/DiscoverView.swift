...
struct DiscoverView: View {
    ...
    var body: some View {
        NavigationStack {
            ...
            .task {
                ...
                VoiceOverAnnouncement.screenChanged(to: "Find workout partners. \(viewModel.users.count) potential partners available.")
            }
            .refreshable {
                HapticManager.shared.impact(.light)
                await viewModel.loadUsers()
                HapticManager.shared.notification(.success)
                VoiceOverAnnouncement.announce("Partners refreshed. \(viewModel.users.count) workout partners available.")
            }
        ...
        HStack {
            VStack(alignment: .leading, spacing: 4) {
                ...
                if !viewModel.users.isEmpty {
                    HStack(spacing: 4) {
                        Text("\(viewModel.remainingCount) workout partners")
                            .font(.subheadline)
            ...
            Button {
                ...
                HapticManager.shared.impact(.light)
                VoiceOverAnnouncement.announce("Partners shuffled")
            } label: {
            ...
            .accessibilityElement(
                label: "Shuffle partners",
                hint: "Randomly reorder the list of potential workout partners",
                traits: .isButton,
            ...
            .accessibilityElement(
                ...
                hint: "Show filters to find your ideal workout partner",
                traits: .isButton,
                ...
                HStack(spacing: 24) {
                    ...
                    SwipeActionButton(
                        ...
                        Task {
                            ...
                            VoiceOverAnnouncement.announce("Super interested sent!")
                        }
                    }
                    .accessibilityElement(
                        label: "Super Interested",
                        hint: "Show extra interest in this workout partner",
                        traits: .isButton,
                    ...
                    SwipeActionButton(
                        ...
                        Task {
                            ...
                            VoiceOverAnnouncement.announce("Interested! Next partner.")
                        }
                    }
                    .accessibilityElement(
                        label: "Interested",
                        hint: "Show interest in this workout partner",
                        traits: .isButton,
    ...
    private var emptyStateView: some View {
        VStack(spacing: 24) {
            ...
            Image(systemName: viewModel.hasActiveFilters ? "line.3.horizontal.decrease.circle" : "figure.run.circle")
                .font(.system(size: 80))
                .foregroundStyle(
                    LinearGradient(
                        colors: [.orange.opacity(0.6), .green.opacity(0.4)],
                        startPoint: .topLeading,
                        endPoint: .bottomTrailing
                    )
                )
            ...
            VStack(spacing: 12) {
                Text(viewModel.hasActiveFilters ? "No Partners Found" : "No More Partners")
                    .font(.title2)
                    .fontWeight(.bold)
                    .dynamicTypeSize(min: .large, max: .accessibility2)
                    .accessibilityAddTraits(.isHeader)
                ...
                Text(viewModel.hasActiveFilters ?
                     "Try adjusting your filters to find more workout partners" :
                     "Check back later for new fitness partners nearby")
                    .font(.subheadline)
                    .foregroundColor(.secondary)
                    .multilineTextAlignment(.center)
                    .padding(.horizontal)
        ...
        ZStack {
            ...
            VStack(spacing: 30) {
                ...
                if let user = viewModel.matchedUser {
                    Text("You and \(user.fullName) want to train together!")
                        .font(.title3)
                        .foregroundColor(.white)
                        .multilineTextAlignment(.center)
            ...
            .task {
                if let user = viewModel.matchedUser {
                    VoiceOverAnnouncement.announce("New workout partner! You and \(user.fullName) want to train together!")
                }
            }
            .padding(40)
        }
    ...
    private func cardView(for user: User, at cardIndex: Int) -> some View {
        UserCardView(user: user)
            ...
            .overlay(alignment: .topTrailing) {
                ...
                if cardIndex == 0 && viewModel.dragOffset.width > 50 {
                    swipeIndicator(icon: "figure.run", color: .green, text: "INTERESTED")
