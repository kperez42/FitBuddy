...
struct TestData {
    ...
    static let discoverUsers: [User] = [
        ...
        User(
            ...
            gender: "Female",
            workoutPreference: "Male",
            bio: "Yoga instructor 🧘‍♀️ | Plant mom 🌱 | Looking for a workout partner who appreciates mindful movement and outdoor activities.",
            location: "Oakland",
            country: "USA",
            latitude: 37.8044,
            longitude: -122.2712,
        ...
        User(
            ...
            gender: "Male",
            workoutPreference: "Female",
            bio: "CrossFit enthusiast by day, DJ by night 🎧 | Music lover | Foodie | Looking for a workout partner to crush morning sessions together.",
            location: "Berkeley",
            country: "USA",
            latitude: 37.8715,
            longitude: -122.2730,
