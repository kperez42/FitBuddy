...
//  FitBuddy
//
//  WORKOUT PARTNERS VIEW - Find Your Training Buddies
    ...
    var body: some View {
        NavigationStack {
            ...
            .task {
                ...
                VoiceOverAnnouncement.screenChanged(to: "Workout partners view. \(matchService.matches.count) partners available.")
            }
            .refreshable {
                ...
                VoiceOverAnnouncement.announce("Partners refreshed. \(matchService.matches.count) workout partners available.")
            }
        ...
        HStack(spacing: 12) {
            ...
            TextField("Search partners...", text: $searchText)
                ...
                .accessibilityElement(
                    label: "Search workout partners",
                    hint: "Type to search your workout partners by name or location",
    ...
    private var tabsView: some View {
        VStack(spacing: 0) {
            HStack(spacing: 12) {
                ...
                .accessibilityLabel("Sort partners by \(sortOption.rawValue)")
                .accessibilityHint("Choose how to sort your workout partners")
            }
            .padding(.horizontal, 20)
            .padding(.vertical, 12)
    ...
    private var emptyStateView: some View {
        VStack(spacing: 24) {
            ...
            VStack(spacing: 12) {
                ...
                Text("Head to Find Partners to start browsing and finding your perfect training buddy!")
                    .font(.subheadline)
            ...
            // Tips
            VStack(spacing: 12) {
                tipRow(icon: "photo.fill", text: "Add photos of your workouts")
                tipRow(icon: "text.alignleft", text: "Share your fitness goals in your bio")
                tipRow(icon: "figure.run", text: "Be active and browse regularly")
            }
            .padding(20)
            .background(Color.white)
            .cornerRadius(16)
