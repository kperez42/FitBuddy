...
struct User: Identifiable, Codable, Equatable {
    ...
    var workoutTypes: [String] = []      // gym, running, yoga, crossfit, etc.
    var preferredWorkoutTimes: [String] = []  // morning, afternoon, evening, etc.
    var gymLocation: String?             // Preferred gym or workout location
    ...
    var religion: String?
    var workoutFrequency: String?  // How often they work out (renamed from exercise)
    var diet: String?
    ...
    func encode(to encoder: Encoder) throws {
        ...
        try container.encode(workoutTypes, forKey: .workoutTypes)
        try container.encode(preferredWorkoutTimes, forKey: .preferredWorkoutTimes)
        try container.encodeIfPresent(gymLocation, forKey: .gymLocation)
        ...
        try container.encodeIfPresent(workoutFrequency, forKey: .workoutFrequency)
    ...
    enum CodingKeys: String, CodingKey {
        case id
        case email, fullName, age, gender, fitnessGoal, bio
        case fitnessLevel, workoutTypes, preferredWorkoutTimes, gymLocation
        ...
        case educationLevel, height, religion, workoutFrequency, diet
        case prompts
    ...
    init(dictionary: [String: Any]) {
        ...
        self.preferredWorkoutTimes = dictionary["preferredWorkoutTimes"] as? [String] ?? []
        self.gymLocation = dictionary["gymLocation"] as? String
        ...
        self.workoutFrequency = dictionary["workoutFrequency"] as? String ?? dictionary["exercise"] as? String
